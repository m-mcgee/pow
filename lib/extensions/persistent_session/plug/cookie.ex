defmodule PowPersistentSession.Plug.Cookie do
  ...
  The token used in the client is signed using `Pow.Plug.sign_token/3` to
  ...
  The token will be signed for client use with `Pow.Plug.sign_token/3`.
  """
